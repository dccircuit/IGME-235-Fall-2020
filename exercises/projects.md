...
For this exercise, we'd like you to explore some sample projects from the last few semesters. The project names and numbers have changed a bit over time, so pay attention to the short descriptions at the top of each section to understand which project you're looking at.  If you find any projects that are especially compelling, fun, or interesting or if you have questions about expectations for projects this semester, feel free to mention/ask them in the "#exercise-pastproj" Slack channel.
...
## When you get done:
- There is no specific submission for this exercise, you do not need to save or submit anything, but you should feel fee to use the "#exercise-pastproj" Slack channel to share anything compelling, fun, or interesting.
- Start making some notes about project features, game ideas, portfolio elements that you might want to incorporate into your own project.  This is one of the to do items in your Week 1 - After Lab - Checklist in myCourses.
